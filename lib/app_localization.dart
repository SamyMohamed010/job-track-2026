...
class AppLocalization extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'You must verify your student account first to be able to apply for jobs.': 'You must verify your student account first to be able to apply for jobs.',
    ...
    'ar': {
      ...
      'UI/UX Design Intern': 'متدرب تصميم واجهات',
      'Lab Assistant': 'مساعد مختبر',
      'Google': 'جوجل',
      'Amazon': 'أمازون',
      'Medical Lab': 'مختبر طبي',
      ...
      'Verification Required': 'التوثيق مطلوب',
      'You must verify your student account first to be able to apply for jobs.': 'يجب توثيق حسابك الطلابي أولاً لتتمكن من التقديم على الوظائف.',
